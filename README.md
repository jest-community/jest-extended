...
- [API](#api)
  ...
  - [Number](#number)
    ...
    - [.toBeNear(value, offset)](#tobenearvalue-offset)
  - [Object](#object)
...
#### .toBeNear(value, offset)
Use `.toBeNear` when checking if a number is a given offset away from a given value
```js
test('passes when number is offset away from value', () => {
  expect(0).not.toBeNear(2, 1);
  expect(1).toBeNear(2, 1);
  expect(2).toBeNear(2, 1);
  expect(3).toBeNear(2, 1);
  expect(4).not.toBeNear(2, 1);
});
```
...
| [<img src="https://avatars0.githubusercontent.com/u/18214059?v=4" width="100px;"/><br /><sub>Alcedo Nathaniel De Guzman Jr</sub>](https://twitter.com/natealcedo)<br />[💻](https://github.com/mattphillips/jest-extended/commits?author=natealcedo "Code") [📖](https://github.com/mattphillips/jest-extended/commits?author=natealcedo "Documentation") [💡](#example-natealcedo "Examples") [⚠️](https://github.com/mattphillips/jest-extended/commits?author=natealcedo "Tests") | [<img src="https://avatars1.githubusercontent.com/u/65444?v=4" width="100px;"/><br /><sub>Pete Hodgson</sub>](http://thepete.net)<br />[💻](https://github.com/mattphillips/jest-extended/commits?author=moredip "Code") | [<img src="https://avatars3.githubusercontent.com/u/14202662?s=460&v=4" width="100px;"/><br /><sub>Paul Happ</sub>](https://github.com/phapp88)<br />[💻](https://github.com/mattphillips/jest-extended/commits?author=phapp88 "Code") [📖](https://github.com/mattphillips/jest-extended/commits?author=phapp88 "Documentation") [💡](#example-phapp88 "Examples") [⚠️](https://github.com/mattphillips/jest-extended/commits?author=phapp88 "Tests") |
